...
$settings['apass'] = 's!lt4dmiN';

// Website title
$settings['website_title'] = "Showdown in Little Tokyo";

// Website URL
$settings['website_url'] = 'http://showdowninlittletokyo.com/';

// Guestbook title
$settings['gbook_title'] = "Showdown in Little Tokyo Guestbook";

// Your e-mail address.
$settings['admin_email'] = 'catnip.fatty@gmail.com';

// URL of the gbook.php file.
$settings['gbook_url'] = 'http://showdowninlittletokyo.com/gbook.php';

// If you want to use a logical anti-SPAM question type it here
$settings['spam_question'] = 'What is Dolph\'s last name?';

// Correct answer to the anti-SPAM logical question
$settings['spam_answer'] = 'lundgren';
...
$settings['filter_sum'] = 'alefjoeFF983843IiIiI888883838833';
